// -----------------------------------------------------------------------------
// Purpose: Display a single discussion thread with its posts and allow replies.
// Features:
// - Real-time Firestore subscription to posts within the thread.
// - Supports plain text + optional image attachments.
// - Uploads images to Firebase Storage with unique keys.
// - Updates "lastPostAt" on thread when replying.
// - Provides a bottom composer with image picker, preview, and send button.
// -----------------------------------------------------------------------------
